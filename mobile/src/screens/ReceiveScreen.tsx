  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.heroCard}>
        ...
        <Text style={styles.subtitle}>Show this QR or copy your wallet address to request payment instantly.</Text>
      </View>
      ...
      <View style={styles.shareCard}>
        <Text style={styles.sectionLabel}>Share string</Text>
